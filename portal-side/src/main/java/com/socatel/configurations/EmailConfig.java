...
public class EmailConfig {
    ...
    @Value("${spring.mail.properties.mail.smtp.from}") private String from;
    @Value("${spring.mail.properties.mail.smtp.auth}") private boolean auth;
    @Value("${spring.mail.properties.mail.smtp.starttls.enable}") private boolean starttlsEnabled;
    @Value("${spring.mail.properties.mail.smtp.starttls.required}") private boolean starttlsRequired;
    @Value("${spring.mail.properties.mail.smtp.ssl.enable}") private boolean sslEnabled;
